...
# 18.1 is the last Quartus with MAX 10 support in this repository's toolchain,
# and is what builds the project.
...
SOF="$HERE/quartus/output_files/de10_lite_avl_mm_firewall_demo.sof"

...
| `altera_avalon_mm_sdram_controller` | yes — 11 configurations, plus Quartus Analysis & Synthesis | yes — 11 configurations, coverage, assertion non-vacuity | — |

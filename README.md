...
Note: You may also need to add to the IP search path - the '../altera_axi4_lite_firewall/example/common', in order to get the AXI4-Lite Firewall examples to open and work properly in Quartus/Qsys.

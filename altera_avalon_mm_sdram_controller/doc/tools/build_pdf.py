...
DOCS = {
    "ug": ("avalon_mm_sdram_controller_user_guide", "User Guide", "1.0",
           "\n# 1. About this core"),
    "diagrams": ("avalon_mm_sdram_controller_block_diagrams",
                 "Block Diagrams and Descriptions", "1.0",
                 "\n# 1. System context"),
}

TITLE = "Avalon-MM SDRAM Controller IP Core"
...
@page {
    ...
    @top-left {
        content: "Avalon-MM SDRAM Controller IP Core — """ + subtitle + """";
    ...
    @bottom-left {
        content: "altera_avalon_mm_sdram_controller";
...
<div class="title-page">
  ...
  <div class="title-meta"><table>
    <tr><td>IP core</td><td><code>altera_avalon_mm_sdram_controller</code></td></tr>
  ...
  <div class="title-foot">
    SDR SDRAM controller for Avalon-MM, with one open row per bank.

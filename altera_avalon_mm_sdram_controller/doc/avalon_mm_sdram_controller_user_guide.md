...
| `simulation/questa/run_sim.tcl` | Coverage and assertion non-vacuity, same 15 configurations | 23 assertion instances, **none vacuous**, 100% FSM state and transition |

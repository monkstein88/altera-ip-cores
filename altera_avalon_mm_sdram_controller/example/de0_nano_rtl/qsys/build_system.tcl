...
#
# The board carries an ISSI IS42S16160B: 32 MB, organised 16M x 16.
#     4 banks x 8192 rows x 512 columns x 16 bits = 256 Mbit = 32 MB
#
# ---------------------------------------------------------------------------
# THE PLL IS AT THE TOP LEVEL, NOT IN HERE
# ---------------------------------------------------------------------------
# The SDRAM needs two clocks: the controller runs on 100 MHz at 0 degrees, and
# the chip itself is clocked by the same 100 MHz shifted -1.667 ns. That shift
...
# looks like a bad memory. -1667 ps is Terasic's value for this board - NOT the DE10-Lite's -3000.
#
...
save_system sdram_nano_sys.qsys
puts "=== system saved ==="

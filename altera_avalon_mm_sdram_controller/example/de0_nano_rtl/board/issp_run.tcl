...
proc f_faddr  {d} { return [field $d 47 24] }
proc f_fexp   {d} { return [field $d 63 48] }
proc f_fact   {d} { return [field $d 79 64] }
proc f_wrcyc  {d} { return [field $d 111 80] }
proc f_rdcyc  {d} { return [field $d 143 112] }
proc f_words  {d} { return [field $d 175 144] }
...
proc f_chk    {d} { return [field $d 216 185] }

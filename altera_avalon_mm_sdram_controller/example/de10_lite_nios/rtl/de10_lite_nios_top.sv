...
// DE10-Lite (Intel MAX 10, 10M50DAF484C7G) and its ISSI IS42S16320D.
//
...
//    clock, shifted early by 3 ns, and ALTPLL's second output cannot be
...
//
// LEDR is driven by software through a PIO, not by hardware: what it shows is

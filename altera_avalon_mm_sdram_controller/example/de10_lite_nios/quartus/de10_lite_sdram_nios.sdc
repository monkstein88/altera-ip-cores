# =============================================================================
# de10_lite_sdram_nios.sdc
#
# Timing constraints for the Nios II SDRAM Controller example on the
# DE10-Lite. Identical to the RTL example's: same board, same part, same
# clocking. Only the design inside the FPGA differs.
#
